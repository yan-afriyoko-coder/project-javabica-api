...
use App\Http\Resources\OrderProductResource\OrderProductSummaryResource;
...
class OrderWithProductResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        if ($this->resource['data']->hasMany_orderProduct) {
            
            $product_order =  $this->resource['data']->hasMany_orderProduct->map(function ($query)  {
                
                return new OrderProductSummaryResource([
                    'data' => $query,
                    'status' => true
                ]);
