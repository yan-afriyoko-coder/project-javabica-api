...
class AssignPermissionUserValidationRequest extends FormRequest
{
    /**
    ...
    public function authorize()
    {
        ...
        if(Auth::user()->can('model_has_permission_create')) 
        {
             return true;
        }
    }
    ...
    {
        return [
            'user_uuid.required'           => 'user tidak boleh kosong',
            'user_uuid.exists'             => 'user tidak ditemukan',
